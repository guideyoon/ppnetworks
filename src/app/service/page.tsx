  ...
  const faqs = [
    {
      ...
      answer: "기본 플랜은 약 2-3주, 프리미엄 플랜은 약 3-4주 소요됩니다. 커스텀 플랜의 경우 요구사항에 따라 상이할 수 있습니다.",
    },
    {
    ...
    {
      question: "제작 후 관리 방법을 알려주시나요?",
      answer: "네, 오픈 시 콘텐츠 관리 가이드를 제공하며, 기본적인 수정 방법을 안내해 드립니다.",
    },
    {
      question: "결제는 어떻게 하나요?",
      answer: "계약 시 50% 선금, 제작 완료 후 잔금 50%로 진행됩니다. 카드, 계좌이체 모두 가능합니다.",
    },
  ];
