...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // 필수 항목 검증
    if (!formData.name || !formData.phone || !formData.businessType || formData.purposes.length === 0 || formData.pages.length === 0) {
            ...
            <CardContent>
              {isSubmitted ? (
                <div className="text-center py-12 space-y-4">
                  ...
                  <h3 className="text-2xl font-semibold text-white">문의가 접수되었습니다</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-4 border-b border-slate-800 pb-6">
                    <h2 className="text-xl font-semibold text-white">1. 기본 정보</h2>
                  ...
                  {/* 2. 사업 정보 */}
                  <div className="space-y-4 border-b border-slate-800 pb-6">
                    <h2 className="text-xl font-semibold text-white">2. 사업 정보</h2>
                  ...
                  <div className="space-y-4 border-b border-slate-800 pb-6">
                    ...
                    <div className="space-y-3">
                      <div className="space-y-2">
                        <Label htmlFor="referenceUrl1" className="text-slate-300">
                          원하는 느낌 홈페이지 URL 1
                        </Label>
                        <Input
                          id="referenceUrl1"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="referenceUrl2" className="text-slate-300">
                          원하는 느낌 홈페이지 URL 2
                        </Label>
                        <Input
                          id="referenceUrl2"
            ...
            <CardContent className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">(문의 필요)</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">(문의 필요)</p>
                  <p className="text-xs text-slate-500 mt-1">24시간 접수 가능</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-full bg-purple-500/10">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">(문의 필요)</p>
                  <p className="text-xs text-slate-500 mt-1">실시간 상담 가능</p>
                </div>
              </div>
            </CardContent>
          </Card>
