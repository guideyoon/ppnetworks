        ...
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            <Card className="bg-white border-slate-200 shadow-sm">
              <CardHeader>
                <CardTitle className="text-purple-600">제1조 (개인정보의 처리 목적)</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4 text-slate-600">
                ...
                <div className="space-y-2">
                  <p><strong className="text-purple-600">1. 홈페이지 제작 서비스 제공</strong></p>
            ...
            <Card className="bg-white border-slate-200 shadow-sm">
              <CardHeader>
                <CardTitle className="text-purple-600">제2조 (개인정보의 처리 및 보유기간)</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4 text-slate-600">
                <p>
                ...
                <div className="space-y-2">
                  <p><strong className="text-purple-600">1. 홈페이지 제작 서비스 문의 및 상담</strong></p>
                  <ul className="list-disc list-inside ml-4 space-y-1 text-slate-600">
            ...
            <Card className="bg-white border-slate-200 shadow-sm">
              ...
              <CardContent className="space-y-4 text-slate-600">
                ...
                <div className="space-y-2">
                  <p><strong className="text-purple-600">1. 필수 항목</strong></p>
                  <ul className="list-disc list-inside ml-4 space-y-1 text-slate-600">
                    <li>이름 또는 상호명</li>
                    <li>휴대폰 번호</li>
                    <li>업종 정보</li>
            ...
            <Card className="bg-white border-slate-200 shadow-sm">
              ...
              <CardContent className="space-y-4 text-slate-600">
                ...
                <div className="space-y-2">
                  <p><strong className="text-purple-600">1. 이메일 발송 서비스</strong></p>
                  <ul className="list-disc list-inside ml-4 space-y-1 text-slate-600">
            ...
            <Card className="bg-white border-slate-200 shadow-sm">
              ...
              <CardContent className="space-y-4 text-slate-600">
                ...
                <div className="space-y-2">
                  <p><strong className="text-purple-600">1. 파기 절차</strong></p>
