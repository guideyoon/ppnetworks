  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative">
        ...
        <div 
          className="fixed top-0 left-0 right-0 bottom-0 bg-cover bg-center bg-no-repeat pointer-events-none" 
          style={{ 
        ...
        <section className="w-full mb-20 py-20 md:py-28 relative" style={{ zIndex: 1 }}>
          <div className="w-full px-4 md:px-8 lg:px-12">
            <ScrollAnimation direction="fade">
              <div className="w-full bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl border border-white/30 overflow-hidden">
                ...
                <div className="relative px-8 md:px-16 lg:px-24 py-12 md:py-16 lg:py-20">
                  {/* Title Section */}
